          ...
          if ($query->rowCount() > 0) {
            foreach ($result as $key => $value) {
              ...
              if ($pickup_location == 1) {
                $sql4 = "SELECT pickup_locations.price, default_pickup_locations.city, default_pickup_locations.state, default_pickup_locations.country, default_pickup_locations.firstname, default_pickup_locations.lastname, default_pickup_locations.address, default_pickup_locations.additional_information FROM pickup_locations
