<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      // $data['sub_product_unique_id'] = $_POST['sub_product_unique_id'];
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        if ($query2->rowCount() > 0) {
          ...
          $sql3 = "SELECT unique_id FROM sub_product_images WHERE sub_product_unique_id=:sub_product_unique_id AND status=:status";
                              ...
                              if((isset($newFilename)) && ($newFilename != "Image already exist")){
                                ...
                                $targetPath = $path; // Target path where file is to be stored
                                 ...
                                 $file = $path;
                                  ...
                                  $sql = "INSERT INTO sub_product_images (unique_id, user_unique_id, edit_user_unique_id, sub_product_unique_id, image, file, file_size, added_date, last_modified, status)
                                  VALUES (:unique_id, :user_unique_id, :edit_user_unique_id, :sub_product_unique_id, :image, :file, :file_size, :added_date, :last_modified, :status)";
