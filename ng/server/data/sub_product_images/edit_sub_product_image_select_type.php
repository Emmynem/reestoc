<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      // $data['sub_product_image_unique_id'] = $_POST['sub_product_image_unique_id'];
      ...
      $sub_product_image_unique_id = isset($_POST['sub_product_image_unique_id']) ? $_POST['sub_product_image_unique_id'] : $data['sub_product_image_unique_id'];
                              ...
                              if((isset($newFilename)) && ($newFilename != "Image already exist")){
                                ...
                                $targetPath = $path; // Target path where file is to be stored
                                 ...
                                 $file = $path;
                                  ...
                                  $sql = "UPDATE sub_product_images SET edit_user_unique_id=:edit_user_unique_id, image=:image, file=:file, file_size=:file_size, last_modified=:last_modified
