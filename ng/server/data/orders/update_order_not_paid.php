    ...
    try {
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        if ($validation["error"] == true) {
          ...
          $sqlOrder = "SELECT delivery_status, user_unique_id FROM orders WHERE unique_id=:unique_id AND user_unique_id=:user_unique_id AND tracker_unique_id=:tracker_unique_id AND paid!=:paid AND status=:status";
          ...
          $queryOrder->bindParam(":paid", $active);
