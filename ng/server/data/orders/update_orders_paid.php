<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      $maangement_user_unique_id = isset($_GET['maangement_user_unique_id']) ? $_GET['maangement_user_unique_id'] : $data['maangement_user_unique_id'];

      $sqlSearchUser = "SELECT unique_id FROM management WHERE unique_id=:unique_id AND status=:status";
      $querySearchUser = $conn->prepare($sqlSearchUser);
      $querySearchUser->bindParam(":unique_id", $maangement_user_unique_id);
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        if (!is_array($order_unique_ids)) {
          ...
          foreach ($order_unique_ids as $key => $order_unique_id){
            ...
            $sqlQuantity = "SELECT quantity, coupon_unique_id, tracker_unique_id, sub_product_unique_id, shipping_fee_unique_id, user_unique_id FROM orders WHERE unique_id=:unique_id AND user_unique_id=:user_unique_id AND paid!=:paid";
            ...
            if ($queryQuantity->rowCount() > 0) {
              ...
              $tracker_unique_id = $the_quantity_details[2];
              ...
              $sub_product_unique_id = $the_quantity_details[3];
              $shipping_fee_unique_id = $the_quantity_details[4];
              $user_unique_id = $the_quantity_details[5];
              ...
              $queryMiniCategory->bindParam(":unique_id", $sub_product_unique_id);
              ...
              if ($query2->rowCount() > 0) {
                ...
                if ($product_sales_price == 0) {
                  ...
                  if ($query7->rowCount() > 0) {
                    ...
                    $sql3 = "SELECT percentage, current_count, name, unique_id, user_unique_id, sub_product_unique_id, mini_category_unique_id FROM coupons WHERE unique_id=:unique_id AND (user_unique_id=:user_unique_id OR sub_product_unique_id=:sub_product_unique_id OR mini_category_unique_id=:mini_category_unique_id) AND expiry_date >:today AND current_count!=0";
                    ...
                    $query3->bindParam(":mini_category_unique_id", $the_mini_category_unique_id);
                    ...
                    if ($query3->rowCount() > 0) {
                      ...
                      $the_coupon_price = (($product_price * $the_coupon_percentage) / 100) * $quantity;
                      ...
                      $the_coupon_mini_category_unique_id = $the_coupon_price_details[6];
                      ...
                      if ($the_coupon_count != 0) {
                        ...
                        if ($query11->rowCount() > 0) {
                          ...
                          $sql5 = "INSERT INTO coupon_history (unique_id, user_unique_id, sub_product_unique_id, mini_category_unique_id, name, price, completion, added_date, last_modified, status)
                          VALUES (:unique_id, :user_unique_id, :sub_product_unique_id, :mini_category_unique_id, :name, :price, :completion, :added_date, :last_modified, :status)";
                          ...
                          $query5->bindParam(":mini_category_unique_id", $the_coupon_mini_category_unique_id);
                          ...
                          if ($query5->rowCount() > 0) {
                            ...
                            $sql6 = "UPDATE coupons SET current_count=:current_count, last_modified=:last_modified WHERE unique_id=:unique_id AND (user_unique_id=:user_unique_id OR sub_product_unique_id=:sub_product_unique_id OR mini_category_unique_id=:mini_category_unique_id)";
                            ...
                            $query6->bindParam(":mini_category_unique_id", $the_coupon_mini_category_unique_id);
                              ...
                              if ($query9->rowCount() > 0) {
                                ...
                                if ($query10->rowCount() > 0) {
                                  ...
                                  if ($current_count_update == 0) {
                                    $sql6 = "UPDATE coupons SET completion=:completion, last_modified=:last_modified WHERE unique_id=:unique_id AND (user_unique_id=:user_unique_id OR sub_product_unique_id=:sub_product_unique_id OR mini_category_unique_id=:mini_category_unique_id)";
                                    $query6 = $conn->prepare($sql6);
                          ...
                          $returnvalue = new genericClass();
                          $returnvalue->engineError = 2;
                          $returnvalue->engineErrorMessage = "Shipping fee not available";
                        }
                  ...
                  if ($query7->rowCount() > 0) {
                    ...
                    if ($query3->rowCount() > 0) {
                      $the_coupon_price_details = $query3->fetch();
                      $the_coupon_percentage = (int)$the_coupon_price_details[0];
                      $the_coupon_price = (($product_sales_price * $the_coupon_percentage) / 100) * $quantity;
                      $the_coupon_count = (int)$the_coupon_price_details[1];
                      $the_coupon_name = $the_coupon_price_details[2];
                      $the_coupon_unique_id = $the_coupon_price_details[3];
                      $the_coupon_user_unique_id = $the_coupon_price_details[4] != null ? $the_coupon_price_details[4] : $user_unique_id;
