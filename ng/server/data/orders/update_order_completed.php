  ...
  if ($connected) {
    ...
    try {
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        $sqlOrder = "SELECT sub_product_unique_id, shipment_unique_id, coupon_unique_id, shipping_fee_unique_id, quantity, payment_method, delivery_status FROM orders WHERE unique_id=:unique_id AND user_unique_id=:user_unique_id AND status=:status";
