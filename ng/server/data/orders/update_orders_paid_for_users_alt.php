      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        if (!is_array($order_unique_ids)) {
          ...
          foreach ($order_unique_ids as $key => $order_unique_id){
            ...
            $sqlQuantity = "SELECT quantity, coupon_unique_id, tracker_unique_id, sub_product_unique_id, shipping_fee_unique_id FROM orders WHERE unique_id=:unique_id AND user_unique_id=:user_unique_id AND tracker_unique_id=:tracker_unique_id AND paid!=:paid";
