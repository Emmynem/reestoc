          ...
          if ($countErrors != 0) {
            ...
            if ($query4->rowCount() > 0) {
              ...
              if ($query->rowCount() > 0) {
                ...
                if ($query3->rowCount() > 0) {
                  ...
                  if ($query10->rowCount() > 0) {
                    ...
                    if ($query6->rowCount() > 0) {
                      ...
                      $returnvalue->resultData = "Completed with services";
                    }
                    else {
                      $returnvalue = new genericClass();
                      $returnvalue->engineError = 2;
                      $returnvalue->engineErrorMessage = "Cart not checked out";
                    }
                ...
                $returnvalue = new genericClass();
                $returnvalue->engineError = 2;
                $returnvalue->engineErrorMessage = "Not inserted (user order)";
              }
