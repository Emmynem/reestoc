    ...
    try {
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        if ($query2->rowCount() > 0) {
          ...
          $sql = "UPDATE products SET edit_user_unique_id=:edit_user_unique_id, mini_category_unique_id=:mini_category_unique_id, sub_category_unique_id=:sub_category_unique_id, category_unique_id=:category_unique_id,
