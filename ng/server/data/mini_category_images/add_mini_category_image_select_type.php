<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      // $data['mini_category_unique_id'] = $_POST['mini_category_unique_id'];
      // $data['upload_type'] = $_POST['upload_type'];

      $user_unique_id = isset($_POST['user_unique_id']) ? $_POST['user_unique_id'] : $data['user_unique_id'];
      $mini_category_unique_id = isset($_POST['mini_category_unique_id']) ? $_POST['mini_category_unique_id'] : $data['mini_category_unique_id'];
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        if ($query2->rowCount() > 0) {
          ...
          $sql3 = "SELECT unique_id FROM mini_category_images WHERE mini_category_unique_id=:mini_category_unique_id AND status=:status";
                              ...
                              if((isset($newFilename)) && ($newFilename != "Image already exist")){
                                ...
                                $targetPath = $path; // Target path where file is to be stored
                                 ...
                                 $file = $path;
                                  ...
                                  $sql = "INSERT INTO mini_category_images (unique_id, user_unique_id, edit_user_unique_id, mini_category_unique_id, image, file, file_size, added_date, last_modified, status)
                                  VALUES (:unique_id, :user_unique_id, :edit_user_unique_id, :mini_category_unique_id, :image, :file, :file_size, :added_date, :last_modified, :status)";
