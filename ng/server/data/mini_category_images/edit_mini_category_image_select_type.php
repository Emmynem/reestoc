<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      // $data['mini_category_image_unique_id'] = $_POST['mini_category_image_unique_id'];
      ...
      $mini_category_image_unique_id = isset($_POST['mini_category_image_unique_id']) ? $_POST['mini_category_image_unique_id'] : $data['mini_category_image_unique_id'];
                              ...
                              if((isset($newFilename)) && ($newFilename != "Image already exist")){
                                ...
                                $targetPath = $path; // Target path where file is to be stored
                                 ...
                                 $file = $path;
                                  ...
                                  $sql = "UPDATE mini_category_images SET edit_user_unique_id=:edit_user_unique_id, image=:image, file=:file, file_size=:file_size, last_modified=:last_modified
                                  WHERE unique_id=:unique_id AND mini_category_unique_id=:mini_category_unique_id";
