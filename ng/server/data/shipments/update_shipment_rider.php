    ...
    try {
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        if ($query3->rowCount() > 0) {
          ...
          $sql4 = "SELECT unique_id FROM shipments WHERE shipment_unique_id!=:shipment_unique_id AND rider_unique_id=:rider_unique_id AND delivery_status!=:delivery_status";
          $query4 = $conn->prepare($sql4);
          $query4->bindParam(":shipment_unique_id", $shipment_unique_id);
          $query4->bindParam(":rider_unique_id", $rider_unique_id);
          $query4->bindParam(":delivery_status", $completed);
          $query4->execute();
          ...
          if ($query4->rowCount() > 0) {
            ...
            $sql = "UPDATE shipments SET edit_user_unique_id=:edit_user_unique_id, rider_unique_id=:rider_unique_id, last_modified=:last_modified WHERE shipment_unique_id=:shipment_unique_id";
            ...
            if ($query->rowCount() > 0) {
              ...
              $returnvalue = new genericClass();
              $returnvalue->engineError = 2;
              $returnvalue->engineErrorMessage = "Not edited (shipment rider)";
            }
          }
