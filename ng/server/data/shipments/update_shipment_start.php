  ...
  if ($connected) {
    ...
    try {
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        $null = $functions->null;
        $completion_status = $functions->shipping;
        ...
        if ($query4->rowCount() > 0) {
          ...
          $query2->bindParam(":delivery_status", $shipping);
          $query2->execute();

          if ($query2->rowCount() > 0) {
            $returnvalue = new genericClass();
            $returnvalue->engineError = 2;
            $returnvalue->engineErrorMessage = "Shipment's started";
          }
          else {
            ...
            $query->bindParam(":delivery_status", $shipping);
            ...
            if ($query->rowCount() > 0) {
              ...
              $returnvalue = new genericClass();
              $returnvalue->engineError = 2;
              $returnvalue->engineErrorMessage = "Not edited (shipment started)";
            }
          }
