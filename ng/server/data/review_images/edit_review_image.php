<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      // $data['review_image_unique_id'] = $_POST['review_image_unique_id'];
      // $data['user_unique_id'] = $_POST['user_unique_id'];
      // $data['review_unique_id'] = $_POST['review_unique_id'];

      $review_image_unique_id = isset($_POST['review_image_unique_id']) ? $_POST['review_image_unique_id'] : $data['review_image_unique_id'];
                            ...
                            if((isset($newFilename)) && ($newFilename != "Image already exist")){
                              ...
                              $targetPath = $path; // Target path where file is to be stored
                               ...
                               $file = $path;
                                ...
                                $sql = "UPDATE review_images SET image=:image, file=:file, file_size=:file_size, last_modified=:last_modified
                                WHERE unique_id=:unique_id AND review_unique_id=:review_unique_id";
