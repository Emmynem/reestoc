<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      // $data['review_unique_id'] = $_POST['review_unique_id'];

      $user_unique_id = isset($_POST['user_unique_id']) ? $_POST['user_unique_id'] : $data['user_unique_id'];
      $review_unique_id = isset($_POST['review_unique_id']) ? $_POST['review_unique_id'] : $data['review_unique_id'];
      ...
      // $path_to_save = "https://www.images.reestoc.com/images/review_images/";
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        if ($query2->rowCount() > 0) {
          ...
          $sql3 = "SELECT unique_id FROM review_images WHERE review_unique_id=:review_unique_id AND status=:status";
                            ...
                            if((isset($newFilename)) && ($newFilename != "Image already exist")){
                              ...
                              $targetPath = $path; // Target path where file is to be stored
                               ...
                               $file = $path;
                                ...
                                $sql = "INSERT INTO review_images (unique_id, user_unique_id, review_unique_id, image, file, file_size, added_date, last_modified, status)
                                VALUES (:unique_id, :user_unique_id, :review_unique_id, :image, :file, :file_size, :added_date, :last_modified, :status)";
