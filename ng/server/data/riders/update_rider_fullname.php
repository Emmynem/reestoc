  ...
  if ($connected) {
    ...
    try {
      ...
      if ($validation["error"] == true) {
        ...
        $sql2 = "SELECT unique_id FROM riders WHERE (email=:email OR phone_number=:phone_number) AND status=:status";
        ...
        if ($query2->rowCount() > 0) {
          ...
          $sql = "UPDATE riders SET fullname=:fullname, last_modified=:last_modified WHERE email=:email OR phone_number=:phone_number";
          ...
          if ($query->rowCount() > 0) {
            ...
            $returnvalue = new genericClass();
            $returnvalue->engineError = 2;
            $returnvalue->engineErrorMessage = "Not edited (rider fullname)";
          }
