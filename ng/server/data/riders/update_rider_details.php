<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      $rider_user_unique_id = isset($_GET['rider_unique_id']) ? $_GET['rider_unique_id'] : $data['rider_unique_id'];
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        if ($validation["error"] == true) {
          ...
          if ($query2->rowCount() > 0) {
            ...
            $sql = "UPDATE riders SET edit_user_unique_id=:edit_user_unique_id, role=:role, access=:access, last_modified=:last_modified WHERE unique_id=:unique_id";
            ...
            if ($query->rowCount() > 0) {
              ...
              $returnvalue = new genericClass();
              $returnvalue->engineError = 2;
              $returnvalue->engineErrorMessage = "Not edited (rider role and access)";
            }
