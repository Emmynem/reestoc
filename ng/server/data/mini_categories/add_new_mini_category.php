    ...
    try {
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        if ($validation["error"] == true) {
          ...
          $sql2 = "SELECT name FROM mini_category WHERE (name=:name OR stripped=:stripped) AND (category_unique_id=:category_unique_id AND sub_category_unique_id=:sub_category_unique_id AND status=:status)";
          ...
          if ($query2->rowCount() > 0) {
            ...
            $sql = "INSERT INTO mini_category (unique_id, user_unique_id, edit_user_unique_id, category_unique_id, sub_category_unique_id, name, stripped, added_date, last_modified, status)
            VALUES (:unique_id, :user_unique_id, :edit_user_unique_id, :category_unique_id, :sub_category_unique_id, :name, :stripped, :added_date, :last_modified, :status)";
            ...
            if ($query->rowCount() > 0) {
              ...
              $returnvalue = new genericClass();
              $returnvalue->engineError = 2;
              $returnvalue->engineErrorMessage = "Not inserted (new mini category)";
            }
          }
