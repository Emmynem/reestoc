<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      // $data['product_unique_id'] = $_POST['product_unique_id'];
      ...
      // $path_to_save = "https://www.images.reestoc.com/images/product_images/";
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        if ($query2->rowCount() > 0) {
          ...
          $sql3 = "SELECT unique_id FROM product_images WHERE product_unique_id=:product_unique_id AND status=:status";
                              ...
                              if((isset($newFilename)) && ($newFilename != "Image already exist")){
                                ...
                                $targetPath = $path; // Target path where file is to be stored
                                 ...
                                 $file = $path;
                                  ...
                                  $sql = "INSERT INTO product_images (unique_id, user_unique_id, edit_user_unique_id, product_unique_id, image, file, file_size, added_date, last_modified, status)
                                  VALUES (:unique_id, :user_unique_id, :edit_user_unique_id, :product_unique_id, :image, :file, :file_size, :added_date, :last_modified, :status)";
