  ...
  if ($connected) {
    ...
    try {
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        $sql2 = "SELECT status FROM sub_category WHERE unique_id=:unique_id AND category_unique_id=:category_unique_id";
        ...
        if ($query2->rowCount() > 0) {
          ...
          $sql4 = "UPDATE mini_category SET sub_category_unique_id=:sub_category_unique_id, edit_user_unique_id=:edit_user_unique_id, last_modified=:last_modified WHERE sub_category_unique_id=:sub_category_unique_id_2";
          $query4 = $conn->prepare($sql4);
          $query4->bindParam(":sub_category_unique_id", $null);
          $query4->bindParam(":sub_category_unique_id_2", $sub_category_unique_id);
          ...
          if ($query4->rowCount() > 0) {
            ...
            $sql5 = "UPDATE products SET sub_category_unique_id=:sub_category_unique_id, edit_user_unique_id=:edit_user_unique_id, last_modified=:last_modified WHERE sub_category_unique_id=:sub_category_unique_id_2";
            $query5 = $conn->prepare($sql5);
            $query5->bindParam(":sub_category_unique_id", $null);
            $query5->bindParam(":sub_category_unique_id_2", $sub_category_unique_id);
            $query5->bindParam(":edit_user_unique_id", $edit_user_unique_id);
            $query5->bindParam(":last_modified", $date_added);
            $query5->execute();

            if ($query5->rowCount() > 0) {
              $sql = "DELETE FROM sub_category WHERE unique_id=:unique_id AND category_unique_id=:category_unique_id";
              ...
              if ($query->rowCount() > 0) {
                ...
                $returnvalue->engineErrorMessage = "Not deleted (sub category)";
              }
            }
            else {
              $sql = "DELETE FROM sub_category WHERE unique_id=:unique_id AND category_unique_id=:category_unique_id";
