    ...
    try {
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        if ($query2->rowCount() > 0) {
          ...
          $sql = "UPDATE sub_category SET edit_user_unique_id=:edit_user_unique_id, category_unique_id=:category_unique_id, last_modified=:last_modified WHERE unique_id=:unique_id";
          ...
          if ($query->rowCount() > 0) {
            ...
            $sql3 = "UPDATE products SET edit_user_unique_id=:edit_user_unique_id, category_unique_id=:category_unique_id,
            last_modified=:last_modified WHERE sub_category_unique_id=:sub_category_unique_id";
