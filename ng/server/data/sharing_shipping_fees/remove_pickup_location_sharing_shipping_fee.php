  ...
  if ($connected) {
    ...
    try {
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        $sql2 = "SELECT unique_id FROM pickup_locations WHERE unique_id=:unique_id AND sharing_unique_id=:sharing_unique_id AND status=:status";
        ...
        if ($query2->rowCount() > 0) {
          ...
          $sql = "UPDATE pickup_locations SET status=:status, last_modified=:last_modified WHERE unique_id=:unique_id AND sharing_unique_id=:sharing_unique_id";
          ...
          if ($query->rowCount() > 0) {
            ...
            $returnvalue->engineErrorMessage = "Not removed (sharing item pickup location shipping fee)";
          }
