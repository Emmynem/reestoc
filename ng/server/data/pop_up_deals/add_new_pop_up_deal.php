                            ...
                            if((isset($newFilename)) && ($newFilename != "Image already exist")){
                              ...
                              if(compressImage($sourcePath, $path, 60) == 1){
                               $file = $path;
                                ...
                                $sql = "INSERT INTO pop_up_deals (unique_id, user_unique_id, url, image, file, file_size, added_date, last_modified, status)
                                ...
                                if($query){
                                  if($count > 1){
                                    ...
                                    $returnvalue->resultData = 'Pop up deal Uploaded Successfully';
                                  }
                                  else{
                                    $returnvalue = new genericClass();
                                    $returnvalue->engineMessage = 1;
