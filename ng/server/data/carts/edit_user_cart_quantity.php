  ...
  if ($connected) {
    ...
    try {
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        $validation = $functions->cart_validation($sub_product_unique_id, $quantity);
        ...
        if ($validation["error"] == true) {
          ...
          if ($query2->rowCount() > 0) {
            ...
            $sql = "UPDATE carts SET quantity=:quantity, last_modified=:last_modified WHERE unique_id=:unique_id AND user_unique_id=:user_unique_id AND sub_product_unique_id=:sub_product_unique_id";
