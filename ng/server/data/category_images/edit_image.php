<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      // $data['the_category_image_unique_id'] = $_POST['the_category_image_unique_id'];
      ...
      $the_category_image_unique_id = isset($_POST['the_category_image_unique_id']) ? $_POST['the_category_image_unique_id'] : $data['the_category_image_unique_id'];
                            ...
                            if((isset($newFilename)) && ($newFilename != "Image already exist")){
                              ...
                              if(compressImage($sourcePath, $path, 60) == 1){
                               $file = $path;
                                ...
                                $sql = "UPDATE category_images SET edit_user_unique_id=:edit_user_unique_id, image=:image, file=:file, file_size=:file_size, last_modified=:last_modified
                                WHERE unique_id=:unique_id AND the_category_unique_id=:the_category_unique_id";
