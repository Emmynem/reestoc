      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        if ($validation["error"] == true) {
          ...
          if ($query2->rowCount() > 0) {
            ...
            $sql = "UPDATE management SET edit_user_unique_id=:edit_user_unique_id, access=:access, last_modified=:last_modified WHERE unique_id=:unique_id";
            ...
            if ($query->rowCount() > 0) {
              ...
              $returnvalue = new genericClass();
              $returnvalue->engineError = 2;
              $returnvalue->engineErrorMessage = "Not edited (management user access)";
            }
