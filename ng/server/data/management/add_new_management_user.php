    ...
    try {
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        if ($validation["error"] == true) {
          ...
          $sql2 = "SELECT email FROM management WHERE email=:email OR phone_number=:phone_number";
          ...
          if ($query2->rowCount() > 0) {
            ...
            $sql = "INSERT INTO management (unique_id, edit_user_unique_id, fullname, email, phone_number, role, added_date, last_modified, access, status)
            ...
            if ($query->rowCount() > 0) {
              ...
              $returnvalue = new genericClass();
              $returnvalue->engineError = 2;
              $returnvalue->engineErrorMessage = "Not inserted (new management user)";
            }
          }
