    ...
    try {
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        if ($validation["error"] == true) {
          ...
          $sql2 = "SELECT address FROM riders_addresses WHERE unique_id=:unique_id AND user_unique_id=:user_unique_id AND status=:status";
          ...
          if ($query2->rowCount() > 0) {
            ...
            $sql = "UPDATE riders_addresses SET firstname=:firstname, lastname=:lastname, address=:address, additional_information=:additional_information, city=:city, state=:state, country=:country,
            ...
            if ($query->rowCount() > 0) {
              ...
              $returnvalue = new genericClass();
              $returnvalue->engineError = 2;
              $returnvalue->engineErrorMessage = "Not edited (rider address)";
            }
