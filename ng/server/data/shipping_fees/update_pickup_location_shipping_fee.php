      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        if (in_array($price,$not_allowed_values) && $price != 0) {
          ...
          if ($query2->rowCount() > 0) {
            ...
            WHERE unique_id=:unique_id AND default_pickup_location_unique_id=:default_pickup_location_unique_id AND sub_product_unique_id=:sub_product_unique_id";
            ...
            if ($query->rowCount() > 0) {
              ...
              $returnvalue = new genericClass();
              $returnvalue->engineError = 2;
              $returnvalue->engineErrorMessage = "Not edited (pickup location shipping fee)";
            }
