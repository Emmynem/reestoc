<?php
  ...
  include_once "../objects/pop_up_deals_obj.php";
  ...
  $pop_up_deals = new PopUpDeals($db);
  ...
  // Returns pop up deals filter in json_encoded array
  $result = $pop_up_deals->get_pop_up_deals_filter($start_date, $end_date);
