<?php
  ...
  $unique_id = isset($_POST['mini_category_unique_id']) ? $_POST['mini_category_unique_id'] : $data["mini_category_unique_id"];

  $result = $product->get_mini_category_images($unique_id);
