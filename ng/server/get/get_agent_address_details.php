<?php
  ...
  $agent_address_unique_id = isset($_POST['agent_address_unique_id']) ? $_POST['agent_address_unique_id'] : $data['agent_address_unique_id'];

  // Returns agent address details in json_encoded array
  $result = $agent_addresses->get_agent_address_details($agent_user_unique_id, $agent_address_unique_id);
