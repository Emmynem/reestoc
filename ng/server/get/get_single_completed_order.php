<?php
  ...
  $order_completed_unique_id = isset($_POST['order_completed_unique_id']) ? $_POST['order_completed_unique_id'] : $data['order_completed_unique_id'];
  ...
  $tracker_unique_id = isset($_POST['tracker_unique_id']) ? $_POST['tracker_unique_id'] : $data['tracker_unique_id'];

  // Returns all user single completed order details in json_encoded array
  $result = $order_history->get_single_completed_order($order_completed_unique_id, $user_unique_id, $order_unique_id, $tracker_unique_id);
