<?php
  ...
  $unique_id = isset($_POST['sub_product_unique_id']) ? $_POST['sub_product_unique_id'] : $data['sub_product_unique_id'];
  $stripped = isset($_POST['stripped']) ? $_POST['stripped'] : $data['stripped'];

  $result = $product->get_sub_product_details($unique_id, $stripped);
