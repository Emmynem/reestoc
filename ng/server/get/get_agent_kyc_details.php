<?php
  ...
  include_once "../objects/agents_kyc_obj.php";
  ...
  $agent_user_kyc = new AgentsKYC($db);

  $agent_user_unique_id = isset($_POST['agent_user_unique_id']) ? $_POST['agent_user_unique_id'] : $data['agent_user_unique_id'];

  // Returns agent kyc details in json_encoded array
  $result = $agent_user_kyc->get_agent_kyc_details($agent_user_unique_id);
