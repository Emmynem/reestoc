<?php
  ...
  // Returns all user completed orders in json_encoded array with product_images array
  $result = $order_history->get_user_completed_orders_for_users($user_unique_id);
