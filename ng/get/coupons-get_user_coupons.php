<?php
  ...
  include_once "../server/objects/coupons_obj.php";
  ...
  // Returns all user coupons in json_encoded array with product_images array
  $result = $coupon->get_user_coupons($user_unique_id);
