<?php
  ...
  include_once "../server/objects/disputes_obj.php";
  ...
  // Returns all user order dispute in json_encoded array with product_images array
  $result = $dispute->get_user_order_dispute($user_unique_id, $order_unique_id);
