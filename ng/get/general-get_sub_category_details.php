<?php
  ...
  include_once "../server/objects/sub_categories_obj.php";
  ...
  // Returns all sub_categories in json_encoded array
  $result = $sub_category->get_sub_category_details_for_users($sub_category_unique_id, $stripped);
