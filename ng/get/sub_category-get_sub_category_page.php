<?php
  ...
  // Returns all sub_category products (long version, with sub arrays) in json_encoded array with product_images array
  $result = $product->get_sub_category_page_for_users($sub_category_unique_id, $stripped);
