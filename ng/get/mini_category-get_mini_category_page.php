<?php
  ...
  // Returns all mini_category products (long version, with sub arrays) in json_encoded array with product_images array
  $result = $product->get_mini_category_page_for_users($mini_category_unique_id, $stripped);
