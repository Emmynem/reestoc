<?php
  ...
  // Returns all new arrivals (recently added) of products in json_encoded array with product_images array
  $result = $product->get_all_new_arrival_products_for_users();
