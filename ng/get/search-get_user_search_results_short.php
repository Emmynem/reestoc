<?php
  ...
  // Returns all search result products (short version) in json_encoded array with product_images array
  $result = $product->get_user_search_short_detail_of_products_for_users($search_word);
