<?php
  ...
  // Returns all category new arrival products (short version) in json_encoded array with product_images array
  $result = $product->get_new_arrival_category_short_detail_of_products_for_users($category_unique_id);
