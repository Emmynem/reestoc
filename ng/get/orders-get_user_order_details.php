<?php
  ...
  // Returns user order details in json_encoded array with product_images array
  $result = $order->get_user_order_details_for_users($user_unique_id, $order_unique_id);
