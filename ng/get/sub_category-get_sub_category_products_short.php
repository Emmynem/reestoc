<?php
  ...
  // Returns all sub_category products (short version) in json_encoded array with product_images array
  $result = $product->get_sub_category_short_detail_of_products_for_users($sub_category_unique_id);
