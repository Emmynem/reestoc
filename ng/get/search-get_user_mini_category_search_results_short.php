<?php
  ...
  // Returns all mini_category search result products (short version) in json_encoded array with product_images array
  $result = $product->get_user_mini_category_search_short_detail_of_products_for_users($search_word, $mini_category_unique_id);
