<?php
  ...
  include_once "../server/objects/shipping_fees_obj.php";
  ...
  $shipping_fee = new ShippingFees($db);

  $sub_product_unique_id = isset($_POST['sub_product_unique_id']) ? $_POST['sub_product_unique_id'] : $data['sub_product_unique_id'];

  // Returns sub product shipping fee details in json_encoded array
  $result = $shipping_fee->get_sub_product_shipping_fees_for_users($sub_product_unique_id);
