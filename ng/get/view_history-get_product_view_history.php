<?php
  ...
  include_once "../server/objects/view_history_obj.php";
  ...
  // Returns all product view history in json_encoded array with product_images array
  $result = $view_history->get_product_view_history($product_unique_id);
