<?php
  ...
  // Returns all category featured products (short version) in json_encoded array with product_images array
  $result = $product->get_featured_category_short_detail_of_products_for_users($category_unique_id);
