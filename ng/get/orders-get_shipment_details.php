<?php
  ...
  // Returns user shipment details for an order in json_encoded array with product_images array
  $result = $order->get_shipment_details_for_users($user_unique_id, $shipment_unique_id);
