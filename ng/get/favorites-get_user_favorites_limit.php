<?php
  ...
  include_once "../server/objects/favorites_obj.php";
  ...
  // Returns all user favorites in json_encoded array with product_images array
  $result = $favorite->get_user_favorites_limit($user_unique_id, $limit);
