<?php
  ...
  include_once "../server/objects/users_obj.php";
  ...
  // Returns all user statistics in json_encoded array with product_images array
  $result = $cart->get_user_stats($user_unique_id);
