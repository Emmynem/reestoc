<?php
  ...
  include_once "../server/objects/users_addresses_obj.php";
  ...
  $user_addresses = new UsersAddresses($db);

  $user_unique_id = isset($_POST['user_unique_id']) ? $_POST['user_unique_id'] : $data['user_unique_id'];
  $user_address_unique_id = isset($_POST['user_address_unique_id']) ? $_POST['user_address_unique_id'] : $data['user_address_unique_id'];

  // Returns user address details in json_encoded array
  $result = $user_addresses->get_user_address_details($user_unique_id, $user_address_unique_id);
