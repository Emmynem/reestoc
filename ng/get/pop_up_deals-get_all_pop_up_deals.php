<?php
  ...
  include_once "../server/objects/pop_up_deals_obj.php";
  ...
  $pop_up_deal = new PopUpDeals($db);
  $data = json_decode(file_get_contents("php://input"), true);

  // Returns all pop_up_deals in json_encoded array with product_images array
  $result = $pop_up_deal->get_all_pop_up_deals_for_users();
