<?php
  ...
  include_once "../server/objects/users_kyc_obj.php";
  ...
  $user_kyc = new UsersKYC($db);

  $user_unique_id = isset($_POST['user_unique_id']) ? $_POST['user_unique_id'] : $data['user_unique_id'];

  // Returns user kyc details in json_encoded array
  $result = $user_kyc->get_user_kyc_details($user_unique_id);
