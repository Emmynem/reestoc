<?php
  ...
  include_once "../server/objects/order_history_obj.php";
  ...
  // Returns all user single completed order in json_encoded array
  $result = $order_history->get_single_completed_order_details_for_users($user_unique_id, $order_unique_id, $tracker_unique_id);
