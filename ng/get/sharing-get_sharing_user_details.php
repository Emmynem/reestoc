<?php
  ...
  $unique_id = isset($_GET['sharing_unique_id']) ? $_GET['sharing_unique_id'] : $data["sharing_unique_id"];
  $user_unique_id = isset($_GET['user_unique_id']) ? $_GET['user_unique_id'] : $data["user_unique_id"];

  // Returns sharing item users in json_encoded array
  $result = $sharing->get_sharing_user_details_for_users($unique_id, $user_unique_id);
