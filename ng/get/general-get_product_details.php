<?php
  ...
  $unique_id = isset($_POST['product_unique_id']) ? $_POST['product_unique_id'] : $data['product_unique_id'];
  $stripped = isset($_POST['stripped']) ? $_POST['stripped'] : $data['stripped'];

  // Returns product details in json_encoded array with product_images array
  $result = $product->get_product_details_for_users($unique_id, $stripped);
