<?php
  ...
  include_once "../server/objects/default_pickup_locations_obj.php";
  ...
  $default_pickup_location = new DefaultPickupLocations($db);
  $data = json_decode(file_get_contents("php://input"), true);

  // Returns all pickup locations in json_encoded array
  $result = $default_pickup_location->get_all_default_pickup_locations_for_users();
