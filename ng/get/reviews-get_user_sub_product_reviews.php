<?php
  ...
  include_once "../server/objects/reviews_obj.php";
  ...
  // Returns user product reviews in json_encoded array with product_images array
  $result = $review->get_user_sub_product_reviews($user_unique_id, $sub_product_unique_id);
