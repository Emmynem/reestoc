<?php
  ...
  include_once "../server/objects/review_history_obj.php";
  ...
  // Returns all product review history in json_encoded array with product_images array
  $result = $review_history->get_product_review_history($product_unique_id);
