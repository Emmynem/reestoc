<?php
  ...
  include_once "../server/objects/offered_services_obj.php";
  ...
  // Returns product offered services in json_encoded array
  $result = $offered_service->get_sub_product_offered_services_for_users($sub_product_unique_id);
