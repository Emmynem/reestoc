<?php
  ...
  include_once "../server/objects/cart_obj.php";
  ...
  $cart_unique_id = isset($_POST['cart_unique_id']) ? $_POST['cart_unique_id'] : $data['cart_unique_id'];

  // Returns user cart details in json_encoded array with product_images array
  $result = $cart->get_user_cart_details_for_users($user_unique_id, $cart_unique_id);
