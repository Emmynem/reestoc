<?php
  ...
  include_once "../server/objects/flash_deals_obj.php";
  ...
  $flash_deal = new FlashDeals($db);
  $data = json_decode(file_get_contents("php://input"), true);

  // Returns all flash_deals in json_encoded array with product_images array
  $result = $flash_deal->get_all_flash_deals_for_users();
