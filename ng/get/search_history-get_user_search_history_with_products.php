<?php
  ...
  include_once "../server/objects/search_history_obj.php";
  ...
  // Returns all user search_history in json_encoded array with products image array
  $result = $search_history->get_user_search_history_with_products($user_unique_id);
