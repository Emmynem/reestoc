<?php
  ...
  // Returns all brand products (short version) in json_encoded array with product_images array
  $result = $product->get_brand_short_detail_of_products_for_users($brand_unique_id);
