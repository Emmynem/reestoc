<?php
  ...
  // Returns all user single order history in json_encoded array with product_images array
  $result = $order_history->get_user_single_order_history_for_users($user_unique_id, $order_unique_id);
