xnyder.controller('categoriesCtrl',function($scope,$rootScope,$http,$timeout,$location,$route,$window,storage,notify){
  ...
  $scope.edit_category = function (unique_id, category) {
  ...
  $scope.view_category = function (category_unique_id, cat_title) {
    ...
    // $location.path("category-view/" + re_title);
    window.open($location.protocol() + "://" + $location.host() + ":" + $location.port() + "/royal/blog/category-view/" + category_unique_id + "/" + re_title);
    // window.open("https://hellobeautifulworld.net/blog/category-view/" + category_unique_id + "/" + re_title);
