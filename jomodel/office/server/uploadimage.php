    ...
    try {
       ...
       if ($connected) {
         ...
         if(!empty($_FILES['file']['name'])){
           ...
           $path = '../../../images/blog_images/background_images/' . $newFilename;
           $path_to_delete = '/images/blog_images/background_images/' . $newFilename;
              ...
              if($fileSize < 30000000){
                ...
                if($fileError <= 0){
                  ...
                  if(file_exists($path)){
                    ...
                    $fileURL = $path;
                    $image_webp_url = "../../../images/blog_images/background_images/" . $image_webp_name;
                     ...
                     if((isset($newFilename)) && ($newFilename != "Image already exist")){
                      ...
                      if(compressImage($sourcePath, $path, 60) == 1){
                        ...
                        $output = '../../../images/blog_images/background_images/' .$the_time . '.webp';
                        $image_webp_url = 'https://www.reestoc.com/images/blog_images/background_images/'.$the_time . ".webp";
                        imagewebp($content,$output);
                        imagedestroy($content);

                         $out['message'] = 'File Uploaded Successfully';
                         $out['image'] = $image_webp_url;
                         $out['file'] = $the_time . '.webp';
               ...
               if ($file_ext == "webp" || $file_ext =="WEBP") {
                 ...
                 if(move_uploaded_file($_FILES['file']['tmp_name'], $path)){
                   $image_ext_url = "https://www.reestoc.com/images/blog_images/background_images/" .$the_time.".".$file_ext;
                   $out['message'] = 'Image Uploaded Successfully';
                   $out['image'] = $image_ext_url;
