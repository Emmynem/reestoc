<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      FROM events INNER JOIN management ON events.user_unique_id = management.unique_id WHERE events.event_date_start >:startdate AND (events.event_date_end <:enddate OR events.event_date_end=:enddate) ORDER BY events.event_date_start ASC";
