    ...
    try {
       ...
       if ($connected) {
         ...
         if(!empty($_FILES['file']['name'])){
           ...
           $path = '../../shop_/' . $newFilename;
           $path_to_delete = 'shop_/' . $newFilename;
              ...
              if($fileSize < 30000000){
                ...
                if($fileError <= 0){
                  ...
                  if(file_exists($path)){
                    ...
                    $fileURL = $path;
                    $image_webp_url = "../../shop_/" . $image_webp_name;
                     ...
                     if((isset($newFilename)) && ($newFilename != "Image already exist")){
                      ...
                      if(compressImage($sourcePath, $path, 60) == 1){
                        ...
                        $output = '../../shop_/' .$the_time . '.webp';
                        $image_webp_url = 'shop_/'.$the_time . ".webp";
               ...
               if ($file_ext == "webp" || $file_ext =="WEBP") {
                 ...
                 if(move_uploaded_file($_FILES['file']['tmp_name'], $path)){
                   $image_ext_url = "shop_/" .$the_time.".".$file_ext;
