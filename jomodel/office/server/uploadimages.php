           ...
           if ($countErrors == 0) {
             ...
             if ($countErrorsExtentions == 0) {
               foreach ($_FILES['file']['name'] as $key => $filename){
                   ...
                   $path = '../../../images/blog_images/post_images/' . $newFilename;
                   $path_to_delete = 'images/blog_images/post_images/' . $newFilename;
                   ...
                   if(($fileType == 'image/jpeg')  || ($fileType == 'image/jpg') || ($fileType == 'image/png')){
                 		...
                 		if($fileSize < 30000000){
                           ...
                           $out['message'] = "Image already exist";
                 					...
                 					$fileURL = $path;
                 					$image_webp_url = "../../../images/blog_images/post_images/" . $image_webp_name;
                              ...
                              $targetPath = $path; // Target path where file is to be stored
                                ...
                                $file = $path;
                                 ...
                                 $newFilenameWithoutExtension = time() . "_" . preg_replace($pattern, $replacement, $string);
                           			...
                           			$output = '../../../images/blog_images/post_images/' .$the_time . '.webp';
                           			$image_webp_url = "https://www.reestoc.com/images/blog_images/post_images/" .$the_time . ".webp";
                                 ...
                                 $sql = "INSERT INTO blog_images (user_unique_id, edit_user_unique_id, unique_id, image, file, file_size, added_date, last_modified, status)
                                 VALUES (:user_unique_id, :edit_user_unique_id, :unique_id, :image, :file, :file_size, :added_date, :last_modified, :status)";
                                 ...
                                 $dir = $_SERVER['DOCUMENT_ROOT']."/cerotics_store";
                                 // $dir = $_SERVER['DOCUMENT_ROOT']; // For online
